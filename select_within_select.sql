...
-- We can refer to values in the outer SELECT within the inner SELECT. We can name the tables 
-- so that we can tell the difference between the inner and outer versions.
